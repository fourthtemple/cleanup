...
import { installTextureFixupMethods } from "./weight-editor/texture-fixup.js";
...
class ModelCleanupEditor {
  constructor() {
    ...
    this.texturePaintNeighborToggle = document.getElementById("texture-neighbor-toggle");
    ...
    this.textureFixupNewMaskButton = document.getElementById("texture-fixup-new-mask");
    this.textureFixupExportButton = document.getElementById("texture-fixup-export");
    this.textureFixupImportButton = document.getElementById("texture-fixup-import");
    this.textureFixupClearButton = document.getElementById("texture-fixup-clear");
    this.textureFixupPadding = document.getElementById("texture-fixup-padding");
    this.textureFixupPaddingOutput = document.getElementById("texture-fixup-padding-output");
    this.textureFixupPreview = document.getElementById("texture-fixup-preview");
    this.textureFixupStatus = document.getElementById("texture-fixup-status");
    this.textureFixupFileInput = document.getElementById("texture-fixup-file");
    this.textureFixupHistogram = document.getElementById("texture-fixup-histogram");
    this.textureFixupTintColor = document.getElementById("texture-fixup-tint-color");
    this.textureFixupTintAmount = document.getElementById("texture-fixup-tint-amount");
    this.textureFixupTintAmountOutput = document.getElementById("texture-fixup-tint-amount-output");
    this.textureFixupToneRange = document.getElementById("texture-fixup-tone-range");
    this.textureFixupHue = document.getElementById("texture-fixup-hue");
    this.textureFixupHueOutput = document.getElementById("texture-fixup-hue-output");
    this.textureFixupSaturation = document.getElementById("texture-fixup-saturation");
    this.textureFixupSaturationOutput = document.getElementById("texture-fixup-saturation-output");
    this.textureFixupBrightness = document.getElementById("texture-fixup-brightness");
    this.textureFixupBrightnessOutput = document.getElementById("texture-fixup-brightness-output");
    this.textureFixupGradeApplyButton = document.getElementById("texture-fixup-grade-apply");
    this.textureFixupGradeCancelButton = document.getElementById("texture-fixup-grade-cancel");
    ...
    this.textureFixupPreviewSerial = 0;
    ...
    this.textureFixupColorGradeSerial = 0;
...
installTextureFixupMethods(ModelCleanupEditor);
